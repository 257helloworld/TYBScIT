<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Practical_09B.aspx.cs" Inherits="Practical_09B.Practical_09B" %>
...
<body style="margin: 30px">
    <form id="form1" runat="server">
        <h2>Create a web application to demonstrate use of GridView button column and GridView events.</h2>
